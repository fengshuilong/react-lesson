...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shoppingListReducer = __webpack_require__(223);

	var reducers = _interopRequireWildcard(_shoppingListReducer);
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					{ store: store },
					_react2.default.createElement(_container.ShoppingList, null)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(210)(global || window || undefined);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(217),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _action = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../actions/action.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	function todoList() {
		...
		switch (action.type) {
			case _action.ADD_ONE:
				return [].concat(_toConsumableArray(state), [action.list]);
			case _action.CHANGE_ONE:
				var index = action.index,
				    done = state[index] ? false : true;
				return [].concat(_toConsumableArray(state.slice(0, index)), [Object.assing({}, state[index], { done: done })], _toConsumableArray(state.slice(index + 1)));
			default:
				return state;
		}
	}
